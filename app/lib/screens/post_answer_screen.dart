...
class _AnswersPageState extends State<AnswersPage> {
  ...
  Widget build(BuildContext context) { 
    var get_answers = FirebaseFirestore.instance.collection('answers').where("question", isEqualTo: this.question_id).snapshots();
    Future<DocumentSnapshot> question = FirebaseFirestore.instance.collection('questions').doc(this.question_id).get();
    _getQuestionId(){
                          ...
                          return Container(
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder: (context,index){
                                  DateTime now = snapshot.data!.docs[index].get('createdAt').toDate();
                                  ...
                                  return Container(
                                    ...
                                    child: Card(
                                        ...
                                        child: Column(
                                          ...
                                          children: <Widget>[
                                            Padding(padding: EdgeInsets.fromLTRB(20.0, 10 , 20, 10),
                                            child: Text(snapshot.data!.docs[index].get('body'),
                                            style: TextStyle(
                                              fontSize: 20,
                  ...
                  ElevatedButton.icon(
                    onPressed: (){
                      FirebaseFirestore.instance.collection('answers').add({
                        ...
                        'user': '${this.authorId}',
                        'question': '${this.question_id}', //update this to fit the current id
